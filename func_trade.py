...
SCALPING_15M_PARAMS = {
    'ema_fast': 5,  # Было 7 - слишком медленно
    'ema_medium': 8,  # Было 14 - слишком медленно
    'ema_slow': 13,  # Было 28 - слишком медленно
    'tsi_long': 8,  # Было 25 - слишком медленно
    'tsi_short': 4,  # Было 13 - слишком медленно
    'tsi_signal': 3,  # Было 13 - слишком медленно
